...
@section('cdn-custom')
    <style>
        ...
        .order-status.shipping {
            background-color: rgba(0, 184, 217, .10);
            /* xanh cyan nhạt */
            color: #006c9c;
        }

        .order-status.cancelled {
            background-color: rgba(255, 72, 66, .10);
            /* đỏ nhạt */
            color: #b72136;
        }
    </style>
                                    ...
                                    <div class="col-xl-3 col-lg-4 tab-style-07 md-mb-50px sm-mb-35px"
                                        ...
                                        <div class="position-sticky top-50px">
                                            <ul
                                                ...
                                                <li class="nav-item">
                                                    <form class="nav-link" data-bs-toggle="tab"
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span class="badge bg-light text-primary fw-normal"><i
                                                                            class="bi bi-person-fill me-1"></i>Customer
                                                                        Info</span>
                                                                </div>
                                                                    ...
                                                                    <table class="table table-borderless table-sm">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="fw-semibold">
                                                                                    {{ Auth::user()->phone ? Auth::user()->phone : 'Chưa cập nhật' }}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="card border-0 shadow-sm h-100">
                                                                            <div class="card-body position-relative">
                                                                                ...
                                                                                <p
                                                                                    class="text-muted text-uppercase fw-semibold small mb-1">
                                                                                    Home Address</p>
                                                        ...
                                                        <div class="col tab-style-03">
                                                            <ul
                                                                ...
                                                                <li class="nav-item-date">
                                                                    Chọn khoảng thời gian<input type="text"
                                                            ...
                                                            <ul
                                                                class="nav justify-content-center text-center fw-500 border-color-light-medium-gray mb-7 gap-2">
                                                                <li class="nav-item"><a
                                                                        class="nav-link active border text-black rounded"
                                                                        data-bs-toggle="tab" href="#tab_third1">Tất cả</a>
                                                                </li>
                                                                <li class="nav-item"><a
                                                                        class="nav-link border text-black rounded"
                                                                        ...
                                                                        <div class="card-body p-4">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="mb-2 mb-md-0">
                                                                                    <span class="text-muted small">Mã đơn
                                                                                        hàng: #12345</span>
                                                                                    <span
                                                                                        class="text-muted small ms-2">01/05/2024</span>
                                                                                </div>
                                                                                <span
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-8 col-md-7">
                                                                                    <h6 class="mb-1">Áo thun nam basic
                                                                                    </h6>
                                                                                    <p class="text-muted small mb-1">Size:
                                                                                        M | Màu: Đen</p>
                                                                                    <p class="text-muted small mb-0">Số
                                                                                        lượng: 1</p>
                                                                                </div>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <h6 class="text-danger mb-2">350.000₫
                                                                                    </h6>
                                                                                    <a href="#"
                                                                                        class="text-primary">
                                                            ...
                                                            <div class="card-body p-4">
                                                                <form action="javascript:void(0);">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-3">
                                                                                <label for="emailInput"
                                                                                    class="form-label text-gray-600">Địa
                                                                                    chỉ email</label>
                                                                                <input type="email"
                                                                                    class="form-control border-gray-300 rounded-lg"
                                                                                    id="emailInput"
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <div class="mb-3">
                                                                                <label for="cityInput"
                                                                                    class="form-label text-gray-600">Thành
                                                                                    phố</label>
                                                                                <input type="text"
                                                                                    class="form-control border-gray-300 rounded-lg"
                                                                                    id="cityInput" placeholder="Thành phố"
                                                                                    value="Phoenix">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-4">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="text"
                                                                                    class="form-control border-gray-300 rounded-lg"
                                                                                    id="countryInput"
                                                                                    placeholder="Quốc gia" value="USA">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-4">
                                                                            <div class="mb-3">
                                                                                <label for="zipcodeInput"
                                                                                    class="form-label text-gray-600">Mã bưu
                                                                                    điện</label>
                                                                                <input type="text"
                                                                                    class="form-control border-gray-300 rounded-lg"
                                                                ...
                                                                <div class="mb-3" id="privacy">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div
                                                                            class="d-flex flex-column align-items-center flex-sm-row mb-3">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <ul class="list-unstyled mb-0">
                                                                            ...
                                                                            <li class="d-flex align-items-center mb-2">
                                                                                <div class="flex-grow-1">
                                                                                    <label
                                                                                        class="form-check-label fs-14 text-gray-600"
