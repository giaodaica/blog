    ...
    <div class="container-fluid">
        <div class="row flex-row-reverse"> 
            ...
            <div class="col-xxl-2 col-lg-3 shop-sidebar" data-anime='{ "el": "childs", "translateY": [-15, 0], "opacity": [0,1], "duration": 300, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <div class="mb-30px">
                    <span class="alt-font fw-500 fs-19 text-dark-gray d-block mb-10px">Danh Mục</span>
                            ...
                            @foreach($categories as $category)
                                ...
                                <li>
                                    <label class="checkbox-container">
                                        <input type="checkbox" name="categories[]" value="{{ $category->id }}" {{ $selected ? 'checked' : '' }}>
                ...
                <div class="mb-30px">
                    ...
                    <ul class="shop-filter color-filter fs-16">
                        @foreach($colors as $color)
                            @php
                                $selected = is_array(request('colors')) && in_array($color->id, request('colors'));
                            @endphp
                            <li>
                                <label class="checkbox-container">
                                    <input type="checkbox" name="colors[]" value="{{ $color->id }}" {{ $selected ? 'checked' : '' }}>
                                    <span class="product-cb product-color-cb" style="background-color: {{ $color->color_name }}"></span>
                                    {{ $color->color_name }}
                                </label>
                ...
                <div class="mb-30px">
                    ...
                    <ul class="shop-filter size-filter fs-16">
                        @foreach($sizes as $size)
                            ...
                            <li>
                                <label class="checkbox-container">
                                    <input type="checkbox" name="sizes[]" value="{{ $size->id }}" {{ $selected ? 'checked' : '' }}>
                ...
                <div class="mb-30px">
                    <span class="alt-font fw-500 fs-19 text-dark-gray d-block mb-10px">Filter by price</span>
                    <ul class="shop-filter price-filter fs-16">
                        ...
                        @foreach($priceRanges as $range => $label)
                            <li>
                                <label class="checkbox-container">
                                    <input type="radio" name="price_range" value="{{ $range }}" {{ $selectedPriceRange == $range ? 'checked' : '' }}>
                                    <span class="product-cb product-category-cb"></span>
                                    {{ $label }}
                                </label>
                            </li>
