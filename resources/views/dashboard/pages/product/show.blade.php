                        ...
                        <div class="mt-0">
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="flex-grow-1 mb-3">
                                    <h4 class="text-break" style="word-break: break-word;">{{ $product->name }}</h4>
                                    <div class="d-flex flex-wrap gap-2 mb-3">
                                        <div class="text-break" style="max-width: 250px; word-break: break-word;">
                                    ...
                                    @if ($product->description)
                                        <div class="border p-3 rounded bg-light text-break" style="word-break: break-word;">
                                            {!! $product->description !!}
                                        </div>
                                    @else
                                    ...
                                    <div class="p-2 border border-dashed rounded">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <h5 class="mb-0 text-break" style="word-break: break-word; max-width: 100%;">
                                                    {{ $product->slug }}
                                                </h5>
                                            </div>
                                        </div>
