                        ...
                        <div class="row gx-lg-5">
                            ...
                            <div class="col-xl-8">
                                <div class="mt-xl-0 mt-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <p><strong>Giá nhập:</strong> {{ number_format($variant->import_price, 0, ',', '.') }} VNĐ</p>
                                        </div>
                                        <div class="col-md-4">
                                            <p><strong>Giá bán niêm yết:</strong> {{ number_format($variant->listed_price, 0, ',', '.') }} VNĐ</p>
                                        </div>
                                        <div class="col-md-4">
                                            <p><strong>Giá bán khuyến mãi:</strong> {{ number_format($variant->sale_price, 0, ',', '.') }} VNĐ</p>
                                        </div>
                                    </div>
