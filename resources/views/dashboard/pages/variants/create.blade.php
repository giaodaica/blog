                            ...
                            <div class="card-body">
                                ...
                                <div id="variant-container">
                                    <div class="row variant-item mb-3">
                                        <!-- Size -->
                                        <div class="col-lg-2">
                                            <select class="form-select @error('variants.0.size_id') is-invalid @enderror" name="variants[0][size_id]" required>
                                        ...
                                        <!-- Color -->
                                        <div class="col-lg-2">
                                            <select class="form-select @error('variants.0.color_id') is-invalid @enderror" name="variants[0][color_id]" required>
                                        ...
                                        <!-- Giá nhập -->
                                        <div class="col-lg-2">
                                            <input type="number" class="form-control @error('variants.0.import_price') is-invalid @enderror" name="variants[0][import_price]" placeholder="Giá nhập" min="0" required>
                                        ...
                                        <!-- Giá niêm yết -->
                                        <div class="col-lg-2">
                                            <input type="number" class="form-control @error('variants.0.listed_price') is-invalid @enderror" name="variants[0][listed_price]" placeholder="Giá niêm yết" min="0" required>
                                        ...
                                        <!-- Giá khuyến mãi -->
                                        <div class="col-lg-2">
                                            <input type="number" class="form-control @error('variants.0.sale_price') is-invalid @enderror" name="variants[0][sale_price]" placeholder="Giá khuyến mãi" min="0">
                                        ...
                                        <!-- Số lượng -->
                                        <div class="col-lg-2">
                                            <input type="number" class="form-control @error('variants.0.stock') is-invalid @enderror" name="variants[0][stock]" placeholder="Số lượng" min="0" required>
                                        ...
                                        <div class="col-lg-2 mt-2">
                                           <input type="file" class="form-control @error('variants.0.variant_image') is-invalid @enderror" name="variants[0][variant_image]" accept="image/*">
