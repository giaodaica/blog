                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-15"><a href="" class="link-primary">{{ $rende_order_items->product_name.' '.$rende_order_items->color_name }}</a></h5>
                                                                <p class="text-muted mb-0">Màu: <span class="fw-medium">{{ $rende_order_items->color_name }}</span></p>
                                                                <p class="text-muted mb-0">Size: <span class="fw-medium">{{ $rende_order_items->size_name }}</span></p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>{{ $rende_order_items->sale_price * 1 }}</td>
                                                    <td>{{ $rende_order_items->quantity }}</td>
                                                    <td class="fw-medium text-end">
                                                        {{ $rende_order_items->sale_price * $rende_order_items->quantity }}
                                                    </td>
                                                </tr>
                                             @endforeach
                                                    ...
                                                    <td colspan="2" class="fw-medium p-0">
                                                        <table class="table table-borderless mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    <td>Tổng đơn :</td>
                                                                    <td class="text-end">{{ $data_order->total_amount }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Giảm giá <span class="text-muted">(VELZON15)</span> : :</td>
