                        ...
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                <div class="d-flex gap-1 flex-wrap">
                                    <a href="{{ route('categories.create') }}" class="btn btn-success" id="addCategory-btn">
                            ...
                            <table class="table table-nowrap align-middle" id="categoryTable">
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="checkAll" value="{{ $category->id }}">
                                            </div>
                                        </th>
                                        <td class="id">
                                            <a href="{{ route('categories.show', $category->id) }}" class="fw-medium link-primary">CAT{{ $category->id }}</a>
                                        </td>
                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Xem">
                                                    <a href="{{ route('categories.show', $category->id) }}" class="text-primary d-inline-block">
                                                ...
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Xóa">
                                                    <form action="{{ route('categories.destroy', $category->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc muốn xóa danh mục này?');" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-link p-0 text-danger d-inline-block remove-item-btn" style="border:none; background:none;">
