...
// countdown make
if ($.fn.countdown !== undefined && $.fn.countdown !== null) {
    $('.countdown-make').each(function () {
        var _this = $(this);
        _this.countdown(_this.attr("data-enddate")).on('update.countdown', function (event) {
            _this.html(event.strftime('' + '<div class="counter-container"><div class="countdown-box first"><div class="number">Chờ %-D:</div><span></span></div>' + '<div class="countdown-box"><div class="number">%H:</div><span></span></div>' + '<div class="countdown-box"><div class="number">%M:</div><span></span></div>' + '<div class="countdown-box last"><div class="number">%S</div><span></span></div></div>'));
        }).on('finish.countdown', function (event) {
            _this.html(event.strftime('' + '<div class="counter-container"><div class="countdown-box first" data-number="00"><div class="number">00</div><span></span></div>' + '<div class="countdown-box"><div class="number">00</div><span></span></div>' + '<div class="countdown-box"><div class="number">00</div><span></span></div>' + '<div class="countdown-box last"><div class="number">00</div><span></span></div></div>'));
        });
    });
}
    /* ===================================
